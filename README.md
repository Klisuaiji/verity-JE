...
Verity 是一个基于 NeoForge 的模组，核心是一个由 **Groq API** 驱动、支持**实时语音对话**的 AI 伙伴。你可以按住按键与它说话，它既能用 **原生 TTS** 朗读回应，也能在游戏中通过音符盒 / 唱片机播放声音。除了对话，Verity还拥有一套完整的内容：恶魔形态 **VERITY**、 **盒子**、**手电筒** 与 **Verity 唱片**。
...
- `assets/minecraft/`：对原版命名空间的**自定义覆盖**（如 `lang/en_us.json`、`texts/splashes.txt`）。

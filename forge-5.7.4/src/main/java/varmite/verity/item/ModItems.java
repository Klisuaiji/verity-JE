...
public class ModItems {
    ...
    public static final RegistryObject<Item> VERITY_DISC = ITEMS.register("verity_disc", () -> new RecordItem(15, () -> (SoundEvent)ModSounds.VERITY_DISC_SOUND.get(), new Item.Properties().m_41487_(1).m_41497_(Rarity.RARE), 3000));
    public static final RegistryObject<Item> VERITY_EDIT_DISC = ITEMS.register("verity_edit_disc", () -> new RecordItem(15, () -> (SoundEvent)ModSounds.VERITY_EDIT_DISC_SOUND.get(), new Item.Properties().m_41487_(1).m_41497_(Rarity.RARE), 400));

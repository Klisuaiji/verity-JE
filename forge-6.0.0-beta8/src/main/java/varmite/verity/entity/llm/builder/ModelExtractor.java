...
public class ModelExtractor {
    public static Path getOrExtractModel() {
        ...
        if (Files.exists(modelDir.resolve("tiny.en-encoder.int8.onnx"), new LinkOption[0]) && Files.exists(modelDir.resolve("tiny.en-decoder.int8.onnx"), new LinkOption[0]) && Files.exists(modelDir.resolve("tiny.en-tokens.txt"), new LinkOption[0])) {
            return modelDir;
        }

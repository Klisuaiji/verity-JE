 ...
 */
package varmite.verity.environment.sounds;
...
public class ModSounds {
    ...
    public static final RegistryObject<SoundEvent> VERITY_DISC_SOUND = SOUND_EVENTS.register("verity_disc", () -> SoundEvent.m_262824_((ResourceLocation)ResourceLocation.fromNamespaceAndPath((String)"verity", (String)"verity_disc")));
    public static final RegistryObject<SoundEvent> VERITY_EDIT_DISC_SOUND = SOUND_EVENTS.register("verity_edit_disc", () -> SoundEvent.m_262824_((ResourceLocation)ResourceLocation.fromNamespaceAndPath((String)"verity", (String)"verity_edit_disc")));

    private static RegistryObject<SoundEvent> registerSoundEvent(String name) {
        return SOUND_EVENTS.register(name, () -> SoundEvent.m_262824_((ResourceLocation)ResourceLocation.fromNamespaceAndPath((String)"verity", (String)name)));
    }

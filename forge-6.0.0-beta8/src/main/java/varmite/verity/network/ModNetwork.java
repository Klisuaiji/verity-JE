...
public class ModNetwork {
    ...
    public static final SimpleChannel INSTANCE = NetworkRegistry.newSimpleChannel((ResourceLocation)ResourceLocation.fromNamespaceAndPath((String)"verity", (String)"main"), () -> "1", "1"::equals, "1"::equals);

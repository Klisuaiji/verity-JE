...
public class VerityConfig {
    ...
    static {
        ...
        DAY_COUNT = builder.comment("The amount of in-game days before Verity turns hostile/demon.").define("dayCount", 5);
        ...
        AI_MODEL = builder.comment("Choose the AI intelligence level.").defineEnum("aiModel", AiModel.FAST);
        AI_PROVIDER = builder.comment("Choose the AI Provider to use for Verity.").defineEnum("aiProvider", AiProvider.GROQ);
        ...
        OLLAMA_TTS_MODEL = builder.comment("The TTS model the mod uses.").define("ollama_tts_model", "kokoro");
        OLLAMA_TTS_VOICE = builder.comment("The voice Kokoro uses.").define("ollama_tts_voice", "am_fenrir");
        ...
        OLLAMA_STT_URL = builder.comment("The URL of the Whisper Server.").define("ollama_stt_url", "http://127.0.0.1:9000/v1/");
        OLLAMA_STT_MODEL = builder.comment("The STT model the mod uses.").define("ollama_stt_model", "models/ggml-large-v3-turbo.bin");
        builder.pop();
        builder.push("Custom");

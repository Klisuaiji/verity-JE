 ...
 *  varmite.verity.triggers.BadKarmaTrigger$TriggerInstance
 */
...
public class BadKarmaTrigger
extends SimpleCriterionTrigger<TriggerInstance> {
    public static final ResourceLocation ID = new ResourceLocation("verity", "badkarma");

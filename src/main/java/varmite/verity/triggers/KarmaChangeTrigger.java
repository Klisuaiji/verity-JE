 ...
 *  varmite.verity.triggers.KarmaChangeTrigger$TriggerInstance
 */
...
public class KarmaChangeTrigger
extends SimpleCriterionTrigger<TriggerInstance> {
    public static final ResourceLocation ID = new ResourceLocation("verity", "karmachange");

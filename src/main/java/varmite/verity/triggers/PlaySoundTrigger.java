 ...
 *  varmite.verity.triggers.PlaySoundTrigger$TriggerInstance
 */
...
public class PlaySoundTrigger
extends SimpleCriterionTrigger<TriggerInstance> {
    public static final ResourceLocation ID = new ResourceLocation("verity", "playsound");
